...
(cl:defmethod cl:initialize-instance :after ((m <robotHandPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotHandPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_ros_interfaces-msg:<robotHandPosition> is deprecated: use kuavo_ros_interfaces-msg:robotHandPosition instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <robotHandPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_ros_interfaces-msg:header-val is deprecated.  Use kuavo_ros_interfaces-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'left_hand_position-val :lambda-list '(m))
(cl:defmethod left_hand_position-val ((m <robotHandPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_ros_interfaces-msg:left_hand_position-val is deprecated.  Use kuavo_ros_interfaces-msg:left_hand_position instead.")
...
(cl:defmethod right_hand_position-val ((m <robotHandPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_ros_interfaces-msg:right_hand_position-val is deprecated.  Use kuavo_ros_interfaces-msg:right_hand_position instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robotHandPosition>)))
  ...
  "kuavo_ros_interfaces/robotHandPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robotHandPosition)))
  "Returns string type for a message object of type 'robotHandPosition"
  "kuavo_ros_interfaces/robotHandPosition")
