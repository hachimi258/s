...
"""autogenerated by genpy from kuavo_ros_interfaces/planArmTrajectoryBezierCurveRequest.msg. Do not edit."""
import codecs
import sys
...
import kuavo_ros_interfaces.msg

class planArmTrajectoryBezierCurveRequest(genpy.Message):
  _md5sum = "fd4c2b9f2a4883680ef63a437da922a8"
  _type = "kuavo_ros_interfaces/planArmTrajectoryBezierCurveRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """kuavo_ros_interfaces/jointBezierTrajectory[] multi_joint_bezier_trajectory
...
float64[] right_control_point"""
  ...
  _slot_types = ['kuavo_ros_interfaces/jointBezierTrajectory[]','float64','float64','string[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kuavo_ros_interfaces.msg.jointBezierTrajectory()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.bezier_curve_points = []
        for i in range(0, length):
          val2 = kuavo_ros_interfaces.msg.bezierCurveCubicPoint()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%sd'%length
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from kuavo_ros_interfaces/planArmTrajectoryBezierCurveResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class planArmTrajectoryBezierCurveResponse(genpy.Message):
  ...
  _type = "kuavo_ros_interfaces/planArmTrajectoryBezierCurveResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class planArmTrajectoryBezierCurve(object):
  _type          = 'kuavo_ros_interfaces/planArmTrajectoryBezierCurve'
