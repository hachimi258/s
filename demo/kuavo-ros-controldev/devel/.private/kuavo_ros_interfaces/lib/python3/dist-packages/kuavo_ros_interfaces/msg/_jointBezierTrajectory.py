...
"""autogenerated by genpy from kuavo_ros_interfaces/jointBezierTrajectory.msg. Do not edit."""
import codecs
import sys
...
class jointBezierTrajectory(genpy.Message):
  ...
  _type = "kuavo_ros_interfaces/jointBezierTrajectory"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """kuavo_ros_interfaces/bezierCurveCubicPoint[] bezier_curve_points
================================================================================
...
float64[] right_control_point"""
  ...
  _slot_types = ['kuavo_ros_interfaces/bezierCurveCubicPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = kuavo_ros_interfaces.msg.bezierCurveCubicPoint()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
