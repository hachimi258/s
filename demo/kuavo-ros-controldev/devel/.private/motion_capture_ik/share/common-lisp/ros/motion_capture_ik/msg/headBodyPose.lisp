...
(cl:defmethod cl:initialize-instance :after ((m <headBodyPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'headBodyPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_capture_ik-msg:<headBodyPose> is deprecated: use motion_capture_ik-msg:headBodyPose instead.")))

(cl:ensure-generic-function 'head_pitch-val :lambda-list '(m))
(cl:defmethod head_pitch-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:head_pitch-val is deprecated.  Use motion_capture_ik-msg:head_pitch instead.")
  (head_pitch m))

(cl:ensure-generic-function 'head_yaw-val :lambda-list '(m))
(cl:defmethod head_yaw-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:head_yaw-val is deprecated.  Use motion_capture_ik-msg:head_yaw instead.")
  (head_yaw m))

(cl:ensure-generic-function 'body_roll-val :lambda-list '(m))
(cl:defmethod body_roll-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_roll-val is deprecated.  Use motion_capture_ik-msg:body_roll instead.")
  (body_roll m))

(cl:ensure-generic-function 'body_pitch-val :lambda-list '(m))
(cl:defmethod body_pitch-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_pitch-val is deprecated.  Use motion_capture_ik-msg:body_pitch instead.")
  (body_pitch m))

(cl:ensure-generic-function 'body_yaw-val :lambda-list '(m))
(cl:defmethod body_yaw-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_yaw-val is deprecated.  Use motion_capture_ik-msg:body_yaw instead.")
  (body_yaw m))

(cl:ensure-generic-function 'body_x-val :lambda-list '(m))
(cl:defmethod body_x-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_x-val is deprecated.  Use motion_capture_ik-msg:body_x instead.")
  (body_x m))

(cl:ensure-generic-function 'body_y-val :lambda-list '(m))
(cl:defmethod body_y-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_y-val is deprecated.  Use motion_capture_ik-msg:body_y instead.")
  (body_y m))

(cl:ensure-generic-function 'body_height-val :lambda-list '(m))
(cl:defmethod body_height-val ((m <headBodyPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_capture_ik-msg:body_height-val is deprecated.  Use motion_capture_ik-msg:body_height instead.")
  (body_height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<headBodyPose>)))
  ...
  "motion_capture_ik/headBodyPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'headBodyPose)))
  "Returns string type for a message object of type 'headBodyPose"
  "motion_capture_ik/headBodyPose")
