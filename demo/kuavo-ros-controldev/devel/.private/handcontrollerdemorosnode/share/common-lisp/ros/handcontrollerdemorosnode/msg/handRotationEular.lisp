...
(cl:defmethod cl:initialize-instance :after ((m <handRotationEular>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'handRotationEular)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handcontrollerdemorosnode-msg:<handRotationEular> is deprecated: use handcontrollerdemorosnode-msg:handRotationEular instead.")))

(cl:ensure-generic-function 'eulerAngles-val :lambda-list '(m))
(cl:defmethod eulerAngles-val ((m <handRotationEular>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handcontrollerdemorosnode-msg:eulerAngles-val is deprecated.  Use handcontrollerdemorosnode-msg:eulerAngles instead.")
  (eulerAngles m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<handRotationEular>)))
  ...
  "handcontrollerdemorosnode/handRotationEular")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'handRotationEular)))
  "Returns string type for a message object of type 'handRotationEular"
  "handcontrollerdemorosnode/handRotationEular")
