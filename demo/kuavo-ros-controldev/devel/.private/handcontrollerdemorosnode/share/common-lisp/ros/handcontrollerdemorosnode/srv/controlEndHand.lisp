...
(cl:defmethod cl:initialize-instance :after ((m <controlEndHand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'controlEndHand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handcontrollerdemorosnode-srv:<controlEndHand-request> is deprecated: use handcontrollerdemorosnode-srv:controlEndHand-request instead.")))
...
(cl:defmethod left_hand_position-val ((m <controlEndHand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handcontrollerdemorosnode-srv:left_hand_position-val is deprecated.  Use handcontrollerdemorosnode-srv:left_hand_position instead.")
...
(cl:defmethod right_hand_position-val ((m <controlEndHand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handcontrollerdemorosnode-srv:right_hand_position-val is deprecated.  Use handcontrollerdemorosnode-srv:right_hand_position instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<controlEndHand-request>)))
  ...
  "handcontrollerdemorosnode/controlEndHandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'controlEndHand-request)))
  "Returns string type for a service object of type 'controlEndHand-request"
  "handcontrollerdemorosnode/controlEndHandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <controlEndHand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'controlEndHand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handcontrollerdemorosnode-srv:<controlEndHand-response> is deprecated: use handcontrollerdemorosnode-srv:controlEndHand-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<controlEndHand-response>)))
  ...
  "handcontrollerdemorosnode/controlEndHandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'controlEndHand-response)))
  "Returns string type for a service object of type 'controlEndHand-response"
  "handcontrollerdemorosnode/controlEndHandResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'controlEndHand)))
  ...
  "handcontrollerdemorosnode/controlEndHand")