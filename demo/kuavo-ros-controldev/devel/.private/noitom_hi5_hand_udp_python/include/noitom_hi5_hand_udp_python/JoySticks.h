// Generated by gencpp from file noitom_hi5_hand_udp_python/JoySticks.msg
// DO NOT EDIT!


#ifndef NOITOM_HI5_HAND_UDP_PYTHON_MESSAGE_JOYSTICKS_H
#define NOITOM_HI5_HAND_UDP_PYTHON_MESSAGE_JOYSTICKS_H
...
struct JoySticks_
{
  typedef JoySticks_<ContainerAllocator> Type;
  ...
  JoySticks_(const ContainerAllocator& _alloc)
    : left_x(0.0)
    , left_y(0.0)
    , left_trigger(0.0)
    , left_grip(0.0)
  ...
  typedef boost::shared_ptr< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> const> ConstPtr;

}; // struct JoySticks_

typedef ::noitom_hi5_hand_udp_python::JoySticks_<std::allocator<void> > JoySticks;

typedef boost::shared_ptr< ::noitom_hi5_hand_udp_python::JoySticks > JoySticksPtr;
typedef boost::shared_ptr< ::noitom_hi5_hand_udp_python::JoySticks const> JoySticksConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator1> & lhs, const ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
{
  ...
  static const char* value(const ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc686b65cdd180a90ULL;
  static const uint64_t static_value2 = 0x46db651d6492ec65ULL;
};

template<class ContainerAllocator>
struct DataType< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::noitom_hi5_hand_udp_python::JoySticks_<ContainerAllocator>& v)
  {
    s << indent << "left_x: ";
...
#endif // NOITOM_HI5_HAND_UDP_PYTHON_MESSAGE_JOYSTICKS_H
