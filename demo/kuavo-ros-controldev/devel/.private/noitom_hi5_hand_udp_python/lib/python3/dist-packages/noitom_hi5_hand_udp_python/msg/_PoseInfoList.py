...
"""autogenerated by genpy from noitom_hi5_hand_udp_python/PoseInfoList.msg. Do not edit."""
import codecs
import sys
...
class PoseInfoList(genpy.Message):
  _md5sum = "f56d5e4df1c0e38a423ead4bde9414b3"
  _type = "noitom_hi5_hand_udp_python/PoseInfoList"
...
"""
  ...
  _slot_types = ['int64','bool','bool','noitom_hi5_hand_udp_python/PoseInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseInfoList, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = noitom_hi5_hand_udp_python.msg.PoseInfo()
        _v3 = val1.position
        _x = _v3
        start = end
        end += 24
