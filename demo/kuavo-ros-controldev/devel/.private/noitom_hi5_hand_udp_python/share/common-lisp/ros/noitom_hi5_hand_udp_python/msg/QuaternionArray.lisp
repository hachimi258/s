...
(cl:defmethod cl:initialize-instance :after ((m <QuaternionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QuaternionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name noitom_hi5_hand_udp_python-msg:<QuaternionArray> is deprecated: use noitom_hi5_hand_udp_python-msg:QuaternionArray instead.")))

(cl:ensure-generic-function 'quaternions-val :lambda-list '(m))
(cl:defmethod quaternions-val ((m <QuaternionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader noitom_hi5_hand_udp_python-msg:quaternions-val is deprecated.  Use noitom_hi5_hand_udp_python-msg:quaternions instead.")
  (quaternions m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QuaternionArray>)))
  ...
  "noitom_hi5_hand_udp_python/QuaternionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QuaternionArray)))
  "Returns string type for a message object of type 'QuaternionArray"
  "noitom_hi5_hand_udp_python/QuaternionArray")
