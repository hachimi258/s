...
(cl:defmethod cl:initialize-instance :after ((m <walkCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'walkCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-msg:<walkCommand> is deprecated: use h12pro_controller_node-msg:walkCommand instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <walkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:mode-val is deprecated.  Use h12pro_controller_node-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <walkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:values-val is deprecated.  Use h12pro_controller_node-msg:values instead.")
  (values m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<walkCommand>)))
  ...
  "h12pro_controller_node/walkCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'walkCommand)))
  "Returns string type for a message object of type 'walkCommand"
  "h12pro_controller_node/walkCommand")
