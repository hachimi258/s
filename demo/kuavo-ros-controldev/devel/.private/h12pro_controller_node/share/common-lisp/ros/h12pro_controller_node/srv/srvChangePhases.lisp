...
(cl:defmethod cl:initialize-instance :after ((m <srvChangePhases-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvChangePhases-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-srv:<srvChangePhases-request> is deprecated: use h12pro_controller_node-srv:srvChangePhases-request instead.")))

(cl:ensure-generic-function 'masterID-val :lambda-list '(m))
(cl:defmethod masterID-val ((m <srvChangePhases-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-srv:masterID-val is deprecated.  Use h12pro_controller_node-srv:masterID instead.")
  (masterID m))

(cl:ensure-generic-function 'stateReq-val :lambda-list '(m))
(cl:defmethod stateReq-val ((m <srvChangePhases-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-srv:stateReq-val is deprecated.  Use h12pro_controller_node-srv:stateReq instead.")
  (stateReq m))

(cl:ensure-generic-function 'subState-val :lambda-list '(m))
(cl:defmethod subState-val ((m <srvChangePhases-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-srv:subState-val is deprecated.  Use h12pro_controller_node-srv:subState instead.")
  (subState m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvChangePhases-request>)))
  ...
  "h12pro_controller_node/srvChangePhasesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvChangePhases-request)))
  "Returns string type for a service object of type 'srvChangePhases-request"
  "h12pro_controller_node/srvChangePhasesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srvChangePhases-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvChangePhases-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-srv:<srvChangePhases-response> is deprecated: use h12pro_controller_node-srv:srvChangePhases-response instead.")))

(cl:ensure-generic-function 'stateRes-val :lambda-list '(m))
(cl:defmethod stateRes-val ((m <srvChangePhases-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-srv:stateRes-val is deprecated.  Use h12pro_controller_node-srv:stateRes instead.")
  (stateRes m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvChangePhases-response>)))
  ...
  "h12pro_controller_node/srvChangePhasesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvChangePhases-response)))
  "Returns string type for a service object of type 'srvChangePhases-response"
  "h12pro_controller_node/srvChangePhasesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvChangePhases)))
  ...
  "h12pro_controller_node/srvChangePhases")