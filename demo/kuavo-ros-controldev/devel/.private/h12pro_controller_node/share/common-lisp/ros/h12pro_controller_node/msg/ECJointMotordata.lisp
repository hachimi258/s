...
(cl:defmethod cl:initialize-instance :after ((m <ECJointMotordata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ECJointMotordata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-msg:<ECJointMotordata> is deprecated: use h12pro_controller_node-msg:ECJointMotordata instead.")))

(cl:ensure-generic-function 'l_pos_pitch-val :lambda-list '(m))
(cl:defmethod l_pos_pitch-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:l_pos_pitch-val is deprecated.  Use h12pro_controller_node-msg:l_pos_pitch instead.")
  (l_pos_pitch m))

(cl:ensure-generic-function 'l_pos_yaw-val :lambda-list '(m))
(cl:defmethod l_pos_yaw-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:l_pos_yaw-val is deprecated.  Use h12pro_controller_node-msg:l_pos_yaw instead.")
  (l_pos_yaw m))

(cl:ensure-generic-function 'l_pos_end-val :lambda-list '(m))
(cl:defmethod l_pos_end-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:l_pos_end-val is deprecated.  Use h12pro_controller_node-msg:l_pos_end instead.")
  (l_pos_end m))

(cl:ensure-generic-function 'r_pos_pitch-val :lambda-list '(m))
(cl:defmethod r_pos_pitch-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:r_pos_pitch-val is deprecated.  Use h12pro_controller_node-msg:r_pos_pitch instead.")
  (r_pos_pitch m))

(cl:ensure-generic-function 'r_pos_yaw-val :lambda-list '(m))
(cl:defmethod r_pos_yaw-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:r_pos_yaw-val is deprecated.  Use h12pro_controller_node-msg:r_pos_yaw instead.")
  (r_pos_yaw m))

(cl:ensure-generic-function 'r_pos_end-val :lambda-list '(m))
(cl:defmethod r_pos_end-val ((m <ECJointMotordata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:r_pos_end-val is deprecated.  Use h12pro_controller_node-msg:r_pos_end instead.")
  (r_pos_end m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ECJointMotordata>)))
  ...
  "h12pro_controller_node/ECJointMotordata")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ECJointMotordata)))
  "Returns string type for a message object of type 'ECJointMotordata"
  "h12pro_controller_node/ECJointMotordata")
