...
(cl:defmethod cl:initialize-instance :after ((m <robotPhase>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotPhase)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-msg:<robotPhase> is deprecated: use h12pro_controller_node-msg:robotPhase instead.")))

(cl:ensure-generic-function 'mainPhase-val :lambda-list '(m))
(cl:defmethod mainPhase-val ((m <robotPhase>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:mainPhase-val is deprecated.  Use h12pro_controller_node-msg:mainPhase instead.")
  (mainPhase m))

(cl:ensure-generic-function 'subPhase-val :lambda-list '(m))
(cl:defmethod subPhase-val ((m <robotPhase>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:subPhase-val is deprecated.  Use h12pro_controller_node-msg:subPhase instead.")
  (subPhase m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robotPhase>)))
  ...
  "h12pro_controller_node/robotPhase")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robotPhase)))
  "Returns string type for a message object of type 'robotPhase"
  "h12pro_controller_node/robotPhase")
