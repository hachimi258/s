...
(cl:defmethod cl:initialize-instance :after ((m <changeAMBACCtrlMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'changeAMBACCtrlMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-srv:<changeAMBACCtrlMode-request> is deprecated: use h12pro_controller_node-srv:changeAMBACCtrlMode-request instead.")))

(cl:ensure-generic-function 'control_mode-val :lambda-list '(m))
(cl:defmethod control_mode-val ((m <changeAMBACCtrlMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-srv:control_mode-val is deprecated.  Use h12pro_controller_node-srv:control_mode instead.")
  (control_mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<changeAMBACCtrlMode-request>)))
  ...
  "h12pro_controller_node/changeAMBACCtrlModeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'changeAMBACCtrlMode-request)))
  "Returns string type for a service object of type 'changeAMBACCtrlMode-request"
  "h12pro_controller_node/changeAMBACCtrlModeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <changeAMBACCtrlMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'changeAMBACCtrlMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-srv:<changeAMBACCtrlMode-response> is deprecated: use h12pro_controller_node-srv:changeAMBACCtrlMode-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<changeAMBACCtrlMode-response>)))
  ...
  "h12pro_controller_node/changeAMBACCtrlModeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'changeAMBACCtrlMode-response)))
  "Returns string type for a service object of type 'changeAMBACCtrlMode-response"
  "h12pro_controller_node/changeAMBACCtrlModeResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'changeAMBACCtrlMode)))
  ...
  "h12pro_controller_node/changeAMBACCtrlMode")