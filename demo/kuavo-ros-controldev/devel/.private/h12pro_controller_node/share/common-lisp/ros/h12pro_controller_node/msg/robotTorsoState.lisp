...
(cl:defmethod cl:initialize-instance :after ((m <robotTorsoState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotTorsoState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name h12pro_controller_node-msg:<robotTorsoState> is deprecated: use h12pro_controller_node-msg:robotTorsoState instead.")))

(cl:ensure-generic-function 'torsoR-val :lambda-list '(m))
(cl:defmethod torsoR-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:torsoR-val is deprecated.  Use h12pro_controller_node-msg:torsoR instead.")
  (torsoR m))

(cl:ensure-generic-function 'torsoRd-val :lambda-list '(m))
(cl:defmethod torsoRd-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:torsoRd-val is deprecated.  Use h12pro_controller_node-msg:torsoRd instead.")
  (torsoRd m))

(cl:ensure-generic-function 'torsoRdd-val :lambda-list '(m))
(cl:defmethod torsoRdd-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:torsoRdd-val is deprecated.  Use h12pro_controller_node-msg:torsoRdd instead.")
  (torsoRdd m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:r-val is deprecated.  Use h12pro_controller_node-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'rd-val :lambda-list '(m))
(cl:defmethod rd-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:rd-val is deprecated.  Use h12pro_controller_node-msg:rd instead.")
  (rd m))

(cl:ensure-generic-function 'rdd-val :lambda-list '(m))
(cl:defmethod rdd-val ((m <robotTorsoState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader h12pro_controller_node-msg:rdd-val is deprecated.  Use h12pro_controller_node-msg:rdd instead.")
  (rdd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robotTorsoState>)))
  ...
  "h12pro_controller_node/robotTorsoState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robotTorsoState)))
  "Returns string type for a message object of type 'robotTorsoState"
  "h12pro_controller_node/robotTorsoState")
