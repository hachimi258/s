// Generated by gencpp from file kuavo_msgs/ikSolveParam.msg
// DO NOT EDIT!


#ifndef KUAVO_MSGS_MESSAGE_IKSOLVEPARAM_H
#define KUAVO_MSGS_MESSAGE_IKSOLVEPARAM_H
...
struct ikSolveParam_
{
  ...
  typedef boost::shared_ptr< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> const> ConstPtr;

}; // struct ikSolveParam_

typedef ::kuavo_msgs::ikSolveParam_<std::allocator<void> > ikSolveParam;

typedef boost::shared_ptr< ::kuavo_msgs::ikSolveParam > ikSolveParamPtr;
typedef boost::shared_ptr< ::kuavo_msgs::ikSolveParam const> ikSolveParamConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kuavo_msgs::ikSolveParam_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kuavo_msgs::ikSolveParam_<ContainerAllocator1> & lhs, const ::kuavo_msgs::ikSolveParam_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
{
  ...
  static const char* value(const ::kuavo_msgs::ikSolveParam_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbe29d8b02ad14da6ULL;
  static const uint64_t static_value2 = 0x80464b8c4f590f98ULL;
};

template<class ContainerAllocator>
struct DataType< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# snopt params\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kuavo_msgs::ikSolveParam_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kuavo_msgs::ikSolveParam_<ContainerAllocator>& v)
  {
...
#endif // KUAVO_MSGS_MESSAGE_IKSOLVEPARAM_H
