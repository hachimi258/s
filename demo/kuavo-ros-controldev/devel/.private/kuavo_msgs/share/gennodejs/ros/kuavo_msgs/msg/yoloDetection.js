...
class yoloDetection {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.data.forEach((val) => {
      bufferOffset = yoloOutputData.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = yoloOutputData.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.data.forEach((val) => {
      length += yoloOutputData.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'kuavo_msgs/yoloDetection';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '442f2c4723f0369e79b97b3e674354d8';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = yoloOutputData.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
