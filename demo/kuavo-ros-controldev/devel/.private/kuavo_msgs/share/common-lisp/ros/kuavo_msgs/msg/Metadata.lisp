...
(cl:defmethod cl:initialize-instance :after ((m <Metadata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Metadata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<Metadata> is deprecated: use kuavo_msgs-msg:Metadata instead.")))
...
(cl:defmethod json_data-val ((m <Metadata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:json_data-val is deprecated.  Use kuavo_msgs-msg:json_data instead.")
  (json_data m))
