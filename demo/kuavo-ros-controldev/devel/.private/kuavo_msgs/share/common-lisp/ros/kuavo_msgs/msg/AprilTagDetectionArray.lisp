...
(cl:defclass <AprilTagDetectionArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector kuavo_msgs-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'kuavo_msgs-msg:AprilTagDetection :initial-element (cl:make-instance 'kuavo_msgs-msg:AprilTagDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetectionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetectionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<AprilTagDetectionArray> is deprecated: use kuavo_msgs-msg:AprilTagDetectionArray instead.")))
...
(cl:defmethod detections-val ((m <AprilTagDetectionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:detections-val is deprecated.  Use kuavo_msgs-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetectionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'kuavo_msgs-msg:AprilTagDetection))
