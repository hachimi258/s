...
(cl:defclass <twoArmHandPose> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (left_pose
    :reader left_pose
    :initarg :left_pose
    :type kuavo_msgs-msg:armHandPose
    :initform (cl:make-instance 'kuavo_msgs-msg:armHandPose))
   (right_pose
    :reader right_pose
    :initarg :right_pose
    :type kuavo_msgs-msg:armHandPose
...
(cl:defmethod cl:initialize-instance :after ((m <twoArmHandPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'twoArmHandPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<twoArmHandPose> is deprecated: use kuavo_msgs-msg:twoArmHandPose instead.")))
...
(cl:defmethod left_pose-val ((m <twoArmHandPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_pose-val is deprecated.  Use kuavo_msgs-msg:left_pose instead.")
  (left_pose m))

(cl:ensure-generic-function 'right_pose-val :lambda-list '(m))
(cl:defmethod right_pose-val ((m <twoArmHandPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_pose-val is deprecated.  Use kuavo_msgs-msg:right_pose instead.")
  (right_pose m))
