...
(cl:defmethod cl:initialize-instance :after ((m <robotHeadMotionData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robotHeadMotionData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<robotHeadMotionData> is deprecated: use kuavo_msgs-msg:robotHeadMotionData instead.")))
