...
(cl:defmethod cl:initialize-instance :after ((m <fkSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'fkSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-srv:<fkSrv-request> is deprecated: use kuavo_msgs-srv:fkSrv-request instead.")))

(cl:ensure-generic-function 'q-val :lambda-list '(m))
(cl:defmethod q-val ((m <fkSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-srv:q-val is deprecated.  Use kuavo_msgs-srv:q instead.")
  (q m))
...
(cl:defmethod cl:initialize-instance :after ((m <fkSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'fkSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-srv:<fkSrv-response> is deprecated: use kuavo_msgs-srv:fkSrv-response instead.")))
