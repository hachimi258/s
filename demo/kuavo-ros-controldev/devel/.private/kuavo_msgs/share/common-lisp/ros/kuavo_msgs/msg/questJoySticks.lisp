...
(cl:defclass <questJoySticks> (roslisp-msg-protocol:ros-message)
  ((left_x
    :reader left_x
    :initarg :left_x
    :type cl:float
...
(cl:defclass questJoySticks (<questJoySticks>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <questJoySticks>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'questJoySticks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<questJoySticks> is deprecated: use kuavo_msgs-msg:questJoySticks instead.")))

(cl:ensure-generic-function 'left_x-val :lambda-list '(m))
(cl:defmethod left_x-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_x-val is deprecated.  Use kuavo_msgs-msg:left_x instead.")
  (left_x m))

(cl:ensure-generic-function 'left_y-val :lambda-list '(m))
(cl:defmethod left_y-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_y-val is deprecated.  Use kuavo_msgs-msg:left_y instead.")
  (left_y m))

(cl:ensure-generic-function 'left_trigger-val :lambda-list '(m))
(cl:defmethod left_trigger-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_trigger-val is deprecated.  Use kuavo_msgs-msg:left_trigger instead.")
  (left_trigger m))

(cl:ensure-generic-function 'left_grip-val :lambda-list '(m))
(cl:defmethod left_grip-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_grip-val is deprecated.  Use kuavo_msgs-msg:left_grip instead.")
  (left_grip m))

(cl:ensure-generic-function 'left_first_button_pressed-val :lambda-list '(m))
(cl:defmethod left_first_button_pressed-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_first_button_pressed-val is deprecated.  Use kuavo_msgs-msg:left_first_button_pressed instead.")
  (left_first_button_pressed m))

(cl:ensure-generic-function 'left_second_button_pressed-val :lambda-list '(m))
(cl:defmethod left_second_button_pressed-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_second_button_pressed-val is deprecated.  Use kuavo_msgs-msg:left_second_button_pressed instead.")
  (left_second_button_pressed m))

(cl:ensure-generic-function 'left_first_button_touched-val :lambda-list '(m))
(cl:defmethod left_first_button_touched-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_first_button_touched-val is deprecated.  Use kuavo_msgs-msg:left_first_button_touched instead.")
  (left_first_button_touched m))

(cl:ensure-generic-function 'left_second_button_touched-val :lambda-list '(m))
(cl:defmethod left_second_button_touched-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_second_button_touched-val is deprecated.  Use kuavo_msgs-msg:left_second_button_touched instead.")
  (left_second_button_touched m))

(cl:ensure-generic-function 'right_x-val :lambda-list '(m))
(cl:defmethod right_x-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_x-val is deprecated.  Use kuavo_msgs-msg:right_x instead.")
  (right_x m))

(cl:ensure-generic-function 'right_y-val :lambda-list '(m))
(cl:defmethod right_y-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_y-val is deprecated.  Use kuavo_msgs-msg:right_y instead.")
  (right_y m))

(cl:ensure-generic-function 'right_trigger-val :lambda-list '(m))
(cl:defmethod right_trigger-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_trigger-val is deprecated.  Use kuavo_msgs-msg:right_trigger instead.")
  (right_trigger m))

(cl:ensure-generic-function 'right_grip-val :lambda-list '(m))
(cl:defmethod right_grip-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_grip-val is deprecated.  Use kuavo_msgs-msg:right_grip instead.")
  (right_grip m))

(cl:ensure-generic-function 'right_first_button_pressed-val :lambda-list '(m))
(cl:defmethod right_first_button_pressed-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_first_button_pressed-val is deprecated.  Use kuavo_msgs-msg:right_first_button_pressed instead.")
  (right_first_button_pressed m))

(cl:ensure-generic-function 'right_second_button_pressed-val :lambda-list '(m))
(cl:defmethod right_second_button_pressed-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_second_button_pressed-val is deprecated.  Use kuavo_msgs-msg:right_second_button_pressed instead.")
  (right_second_button_pressed m))

(cl:ensure-generic-function 'right_first_button_touched-val :lambda-list '(m))
(cl:defmethod right_first_button_touched-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_first_button_touched-val is deprecated.  Use kuavo_msgs-msg:right_first_button_touched instead.")
  (right_first_button_touched m))

(cl:ensure-generic-function 'right_second_button_touched-val :lambda-list '(m))
(cl:defmethod right_second_button_touched-val ((m <questJoySticks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_second_button_touched-val is deprecated.  Use kuavo_msgs-msg:right_second_button_touched instead.")
  (right_second_button_touched m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <questJoySticks>) ostream)
  "Serializes a message object of type '<questJoySticks>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <questJoySticks>) istream)
  "Deserializes a message object of type '<questJoySticks>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<questJoySticks>)))
  "Returns string type for a message object of type '<questJoySticks>"
  "kuavo_msgs/questJoySticks")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'questJoySticks)))
  "Returns string type for a message object of type 'questJoySticks"
  "kuavo_msgs/questJoySticks")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<questJoySticks>)))
  "Returns md5sum for a message object of type '<questJoySticks>"
  "c686b65cdd180a9046db651d6492ec65")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'questJoySticks)))
  "Returns md5sum for a message object of type 'questJoySticks"
  "c686b65cdd180a9046db651d6492ec65")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<questJoySticks>)))
  "Returns full string definition for message of type '<questJoySticks>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'questJoySticks)))
  "Returns full string definition for message of type 'questJoySticks"
  (cl:format cl:nil "float32 left_x~%float32 left_y~%float32 left_trigger~%float32 left_grip~%bool left_first_button_pressed~%bool left_second_button_pressed~%bool left_first_button_touched~%bool left_second_button_touched~%float32 right_x~%float32 right_y~%float32 right_trigger~%float32 right_grip~%bool right_first_button_pressed~%bool right_second_button_pressed~%bool right_first_button_touched~%bool right_second_button_touched~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <questJoySticks>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <questJoySticks>))
  "Converts a ROS message object to a list"
  (cl:list 'questJoySticks
