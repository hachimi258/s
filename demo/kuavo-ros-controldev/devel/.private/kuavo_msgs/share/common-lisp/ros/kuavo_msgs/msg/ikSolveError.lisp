...
(cl:defclass <ikSolveError> (roslisp-msg-protocol:ros-message)
  ((ik_type
   ...
   (left_pose_error
    ...
    :type kuavo_msgs-msg:handPose
    :initform (cl:make-instance 'kuavo_msgs-msg:handPose))
   (right_pose_error
...
(cl:defmethod cl:initialize-instance :after ((m <ikSolveError>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ikSolveError)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-msg:<ikSolveError> is deprecated: use kuavo_msgs-msg:ikSolveError instead.")))

(cl:ensure-generic-function 'ik_type-val :lambda-list '(m))
(cl:defmethod ik_type-val ((m <ikSolveError>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:ik_type-val is deprecated.  Use kuavo_msgs-msg:ik_type instead.")
  (ik_type m))

(cl:ensure-generic-function 'left_pose_error-val :lambda-list '(m))
(cl:defmethod left_pose_error-val ((m <ikSolveError>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:left_pose_error-val is deprecated.  Use kuavo_msgs-msg:left_pose_error instead.")
  (left_pose_error m))

(cl:ensure-generic-function 'right_pose_error-val :lambda-list '(m))
(cl:defmethod right_pose_error-val ((m <ikSolveError>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-msg:right_pose_error-val is deprecated.  Use kuavo_msgs-msg:right_pose_error instead.")
  (right_pose_error m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ikSolveError>)))
  ...
  (cl:format cl:nil "string     ik_type ~%handPose  left_pose_error~%handPose  right_pose_error~%================================================================================~%MSG: kuavo_msgs/handPose~%# pos~%float64 x~%float64 y~%float64 z~%# rpy~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ikSolveError)))
  "Returns full string definition for message of type 'ikSolveError"
  (cl:format cl:nil "string     ik_type ~%handPose  left_pose_error~%handPose  right_pose_error~%================================================================================~%MSG: kuavo_msgs/handPose~%# pos~%float64 x~%float64 y~%float64 z~%# rpy~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
