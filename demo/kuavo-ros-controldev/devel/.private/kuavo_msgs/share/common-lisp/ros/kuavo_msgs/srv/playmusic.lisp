...
(cl:defmethod cl:initialize-instance :after ((m <playmusic-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'playmusic-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-srv:<playmusic-request> is deprecated: use kuavo_msgs-srv:playmusic-request instead.")))

(cl:ensure-generic-function 'music_number-val :lambda-list '(m))
(cl:defmethod music_number-val ((m <playmusic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-srv:music_number-val is deprecated.  Use kuavo_msgs-srv:music_number instead.")
  (music_number m))
...
(cl:defmethod cl:initialize-instance :after ((m <playmusic-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'playmusic-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kuavo_msgs-srv:<playmusic-response> is deprecated: use kuavo_msgs-srv:playmusic-response instead.")))

(cl:ensure-generic-function 'success_flag-val :lambda-list '(m))
(cl:defmethod success_flag-val ((m <playmusic-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kuavo_msgs-srv:success_flag-val is deprecated.  Use kuavo_msgs-srv:success_flag instead.")
  (success_flag m))
